...
public class MethodType1 extends MethodTypeDecl {

    private MethTypeName MethTypeName;
    private FormParams FormParams;
    private VarDeclList VarDeclList;

    public MethodType1 (MethTypeName MethTypeName, FormParams FormParams, VarDeclList VarDeclList) {
