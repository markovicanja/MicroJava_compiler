...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(TerExpr2 TerExpr2) { visit(); }
    public void visit(TerExpr1 TerExpr1) { visit(); }
    public void visit(TernaryCond TernaryCond) { visit(); }
    ...
    public void visit(AssignmentExpr AssignmentExpr) { visit(); }
    ...
    public void visit(DesignatorMethodCall DesignatorMethodCall) { visit(); }
    public void visit(DesignatorMethodCallParams DesignatorMethodCallParams) { visit(); }
    ...
    public void visit(StmtWhileBody StmtWhileBody) { visit(); }
    ...
    public void visit(StmtSwitchNoCase StmtSwitchNoCase) { visit(); }
    ...
    public void visit(ClassDecl7 ClassDecl7) { visit(); }
    public void visit(ClassDecl6 ClassDecl6) { visit(); }
    public void visit(ClassDecl5 ClassDecl5) { visit(); }
    ...
    public void visit(ConstMulti ConstMulti) { visit(); }
    public void visit(ConstDeclaration ConstDeclaration) { visit(); }
    public void visit(PartClassDeclaration PartClassDeclaration) { visit(); }
    public void visit(PartVarDeclaration PartVarDeclaration) { visit(); }
    public void visit(PartConstDeclaration PartConstDeclaration) { visit(); }
    public void visit(ProgramDeclEps ProgramDeclEps) { visit(); }
    public void visit(ProgramDeclMulti ProgramDeclMulti) { visit(); }
